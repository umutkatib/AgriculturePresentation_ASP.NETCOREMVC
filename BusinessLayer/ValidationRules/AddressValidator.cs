...
namespace BusinessLayer.ValidationRules
{
    public class AddressValidator : AbstractValidator<Address>
    {
        public AddressValidator()
        {
            ...
            RuleFor(x => x.Description1).MaximumLength(25).WithMessage("Açıklama 1 maximum 25 karaktertir");
            RuleFor(x => x.Description2).MaximumLength(25).WithMessage("Açıklama 2 maximum 25 karaktertir");
            RuleFor(x => x.Description3).MaximumLength(25).WithMessage("Açıklama 3 maximum 25 karaktertir");
            RuleFor(x => x.Description4).MaximumLength(25).WithMessage("Açıklama 4 maximum 25 karaktertir");
